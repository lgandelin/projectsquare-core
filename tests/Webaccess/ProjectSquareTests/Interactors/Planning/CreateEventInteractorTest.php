...
class CreateEventInteractorTest extends BaseTestCase
{
    ...
    {
        parent::__construct();
        $this->interactor = new CreateEventInteractor($this->eventRepository, $this->notificationRepository, $this->ticketRepository, $this->projectRepository, $this->taskRepository, $this->userRepository);
    }
